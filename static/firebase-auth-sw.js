//TODO: Dont know if process.env works (probably not)
// try to get this from the firebase config in nuxt.config.ts
const env = {
  FB_API_Key!,
  FB_AUTH_DOMAIN!,
  FB_DATABASE_URL!,
...
importScripts('https://www.gstatic.com/firebasejs/8.0.1/firebase-auth.js');
